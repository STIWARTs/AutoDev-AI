    ...
    <div className="flex min-h-screen bg-brand-bg font-body">
      ...
      <aside className="fixed left-0 top-0 h-full w-[248px] flex flex-col z-40 bg-brand-bg border-r border-brand-border">
        ...
        <div className="px-5 pt-5 pb-4">
          ...
          <Link
            href="/dashboard"
            className="flex items-center gap-2 px-3 py-2.5 border border-brand-border hover:border-brand/40 transition-colors duration-200 group"
          >
            <ChevronLeft className="w-3 h-3 text-brand-muted group-hover:text-brand transition-colors flex-shrink-0" />
          ...
          {/* ⌘K search hint */}
          <button className="mt-2 flex items-center justify-between w-full px-3 py-2 border border-brand-border hover:border-brand/30 transition-colors group text-left">
              ...
              >
                ...
                <Icon
                  className={`w-[14px] h-[14px] flex-shrink-0 transition-colors ${
                    isActive ? "text-brand" : "text-brand-muted group-hover:text-brand-text"
                  }`}
                />
                {item.label}
              </Link>
        ...
        <div className="p-4 border-t border-brand-border space-y-2">
          <div className="flex items-center gap-2 px-3 py-2 bg-brand/5 border border-brand/20">
            ...
            <p className="text-[11px] text-brand font-medium tracking-wide flex-1">Demo Mode</p>
            <span className="text-[9px] font-mono text-brand/70 border border-brand/20 px-1.5 py-0.5">LIVE</span>
          </div>
        ...
        <div className="flex items-start justify-between px-8 py-5 border-b border-brand-border bg-brand-bg/95 backdrop-blur-sm sticky top-0 z-30">
          <div>
            ...
            <div className="flex items-center gap-1.5 mb-1.5">
              ...
              <span className="text-brand-border font-mono text-[10px]">/</span>
              <span className="text-[10px] text-brand font-mono uppercase tracking-wider">{title}</span>
            </div>
